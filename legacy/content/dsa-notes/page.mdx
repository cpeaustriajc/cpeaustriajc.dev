export const meta = {
  ...
  description:
    'This is an ongoing series for me learning about data structures and algorithms using C++, I am writing about it so that I can retain my knowledge about it.',
  publishedDate: '2022-06-16',
  topics: ['devlog', 'education', 'c++'],
  draft: false,
};
