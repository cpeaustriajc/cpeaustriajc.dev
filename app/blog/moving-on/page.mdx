export const meta = {
  title: 'Moving On',
  description:
    'In this post that is not related to programming (for the first time), It is about moving on from the things that hurt you. And how you can give yourself your own closure even if you were not given one.',
  publishedDate: '2023-03-11',
  topics: ['life', 'mental health', 'education'],
  draft: false,
};
